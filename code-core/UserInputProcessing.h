...
enum class ACTION_TYPE : uint16_t { // Specifying uint16_t ensures that it is of 2 bytes only.
    ...
    DATA_TREE_SET_ACTIVE_BRANCH = 30007,
    OPEN_INTERNAL_SUB_TAB = 30008,
    ACTIVATE_INTERNAL_SUB_TAB = 30009,
    CLOSE_INTERNAL_SUB_TAB = 30010,
    CREATE_LINE2D = 30011,
    BEGIN_LINE_CREATION2D = 30012,
    BEGIN_POLYLINE_CREATION2D = 30013,
    BEGIN_POLYGON_CREATION2D = 30014,
    BEGIN_TEXT_CREATION2D = 30015,
