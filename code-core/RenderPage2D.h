...
/* Resolves the snap under `input` and publishes it as the hover marker for the render thread
(snapping.md sections 8 and 12). Called ONCE per drain of the tab's input queue, from the coalesced
snapHoverInput - never per mouse report. No-op unless the input view is a Page2D. */
