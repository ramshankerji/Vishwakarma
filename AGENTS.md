...
Architecture notes and domain memory are in `.agents/memory/` (see `.agents/memory/MEMORY.md`).  
Workflow skills (e.g. ribbon command pipeline, .yyy test harness) are in `.agents/skills/`.  
